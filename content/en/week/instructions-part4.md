...
Depending on your stream, drawing on at least 3|4|5 different tutorials you've worked through, to identify and communicate some interesting historical observations from the data you've selected. Do what analysis you can, and then imagine the possible directions such research might take, based on what you've encountered in this course so far. Evaluate what you could do in terms of your learning curve with digital history versus where you'd like it to go. (ie, I realize that it's not realistic for you to complete an entire work of digital history within the time available, but I want you to do as much as you can with what you've got.) You ought to situate your work within some of the literature you've read for this course. You are welcome to draw from any reflections or log files you may have already created, suitably edited.

Put the results of this exercise (any digital ephemera you might create) into a new repo in your github, called 'DH-Exploration-Exercise'. Have a log file for the nuts-and-bolts work; in a separate file communicate the results in an appropriate format.
